...
A notebook file is JSON: the cells' sources, their saved outputs and derivations, and the studio's
...
right, and Tab or a following space inserts it. This is the input method of the Lean editor
